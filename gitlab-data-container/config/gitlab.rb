...
external_url = 'https://gitlab.gordonburgett.net'
...
gitlab_rails['backup_upload_remote_directory'] = 'gordonburgett.net/backup/gitlab'
...
gitlab_rails['smtp_user_name'] = "postmaster@mg.gordonburgett.net"
